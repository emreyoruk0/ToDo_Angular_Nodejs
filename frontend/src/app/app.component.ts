...
export class AppComponent implements OnInit {
  ...
  add(){
    ...
    // post<MessageResponseModel> ile istek sonucunda MessageResponseModel tipinde dönüş yapacağını belirttik
    this._http.post<MessageResponseModel>(this.apiUrl + "/add", model).subscribe(res => {
  ...
  delete(model: TodoModel){
    this._http.post<MessageResponseModel>(this.apiUrl + "/delete", model).subscribe(res => {
      this._toastr.success(res.message);
      this.getAll();
    });
  }
  ...
  update(){
    this._http.post<MessageResponseModel>(this.apiUrl + "/update", this.updateModel).subscribe(res => {
      this._toastr.success(res.message);
      this.getAll();
    });
  }
